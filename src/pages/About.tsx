...
const About = () => {
  ...
  const handleSectionToggle = useCallback(
    (key: string, isOpen: boolean) => {
      ...
      const openCount =
        Object.values(openSections).filter(Boolean).length + (isOpen ? 1 : 0);
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-8">
        ...
        <div className="flex-1">
          <p className="mb-4 text-base font-medium text-zinc-700 dark:text-zinc-200 leading-relaxed">
            I am a Senior/Lead Product Designer with over 13 years of experience
            in SaaS and technical products, based in Espoo, Finland. My journey
            started with coding and evolved into design when I realized I could
            bridge the gap between technical complexity and user needs. My work
            focuses on turning complex technical systems into intuitive digital
          ...
          <p className="text-base font-medium text-zinc-700 dark:text-zinc-200 leading-relaxed">
            My background in software development gives me a unique perspective
            on product design. Having written code and built systems myself, I
            understand the technical constraints and possibilities that
            developers face. This knowledge helps me create designs that are not
            only user-friendly but also technically feasible and maintainable.
            When I design interfaces for complex systems, I can anticipate
            implementation challenges and work closely with engineering teams to
            find practical solutions that balance user needs with technical
            requirements.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <ul className="list-disc pl-8 space-y-1 mt-4">
          ...
          <li>
            Contributed to Nokia's enterprise analytics platform before
            transitioning to focus on benchmarking and performance tools at UL
            Solutions
          </li>
        </ul>
      </ExperienceCard>
      ...
      >
        <p>
          ...
          technologies, growing from UX Engineer to Lead Designer over 9 years:
        </p>
        <ul className="list-disc pl-8 space-y-1 mt-4">
          <li>
      ...
      <h3 className="text-xl font-medium mb-4 mt-8 text-zinc-900 dark:text-white">
        Education
      </h3>
      <ExperienceCard
      ...
      >
        ...
        <p className="mt-2 text-base text-zinc-700 dark:text-zinc-200 leading-relaxed">
          Major in Information Systems with focus on software development,
          database management, and system architecture. The program covered web
          technologies, user interface design, and enterprise software
          solutions, providing a strong foundation for technical product design
          and development.
        </p>
      </ExperienceCard>
      <ExperienceCard
      ...
      >
        ...
        <p className="mt-2 text-base text-zinc-700 dark:text-zinc-200 leading-relaxed">
          Comprehensive UX design certification covering user research,
          wireframing, prototyping, and usability testing. The program included
          hands-on projects focused on creating user-centered design solutions,
          conducting user interviews, and developing interactive prototypes.
          This certification strengthened my understanding of design thinking
          methodologies and user experience best practices.
        </p>
      </ExperienceCard>
      <Footer />
      {Object.values(openSections).some(Boolean) &&
