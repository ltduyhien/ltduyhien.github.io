...
const githubProjects = [
  {
    title: "Humidifier",
    description:
      "Android app for humidity and temperature monitoring using OpenWeather API and GPS location",
    url: "https://github.com/ltduyhien/humidifier",
  },
  {
    title: "3DMark Benchmark Result",
    description:
      "Landing page to show benchmark results from users with Time Spy Extreme task",
  ...
  return (
    <div className="container-custom px-8 pt-24 pb-16 md:pt-8 md:pb-16 max-w-2xl mx-auto">
      ...
      <p className="mb-4 text-base font-medium text-zinc-700 dark:text-zinc-200 leading-relaxed">
        I specialize in front-end and mobile development, with skills in React,
        TypeScript, and modern web technologies. I also have sufficient
        experience in backend development and DevOps practices. For mobile
        development, I work with native Android development, creating apps that
        deliver smooth user experiences across different devices and screen
        sizes.
      </p>
      <p className="mb-6 text-base font-medium text-zinc-700 dark:text-zinc-200 leading-relaxed">
        My development work focuses on creating responsive, accessible, and
        performant user interfaces. I build with React ecosystem tools,
        implement responsive design principles. I prioritize clean code
        architecture, component reusability, and maintainable codebases that
